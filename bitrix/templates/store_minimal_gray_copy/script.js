...
function rotate_new() {
  var curID = $("#curItemId").val();
  var divHeight = $('#main-new-block').height();
  $('#main-new-block-inner').fadeOut("slow", function() {
    $.post("ajax/main-new-item.php",{curID:curID},AfterNewShow);
  });
}
